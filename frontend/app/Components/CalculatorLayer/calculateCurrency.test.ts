...
describe('currencyConversion',()=>{
    it("calculates multiple currency expressions into USD",async()=>{
        ...
        const userInput: string = "100USD+350GBP-130CAD"
    ...
    it("throws if a missing currency",async()=>{
        const rates = {USD:1};
        await expect(currencyConversion("10EUR",rates,"USD")).rejects.toThrow(
